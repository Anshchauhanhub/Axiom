...
async def generate_onboarding_response(messages: list[dict]) -> dict:
    ...
    system_prompt = (
        ...
        "When you reach the 'ready' phase and the roadmap is finalized, you MUST explicitly tell the user in your message to click the '**Activate Neural Path**' button at the bottom of the interface to save the goal and begin their journey.\n"
        "\n"
        "### OUTPUT FORMAT:\n"
