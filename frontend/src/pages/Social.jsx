...
import { getSocialFeed, createSocialPost, listGoals, getProfile } from '../services/api';
          ...
          <div className="glass-panel rounded-xl overflow-hidden border border-white/5">
            <div className="h-16 bg-gradient-to-r from-primary/40 via-secondary/40 to-primary/40 relative">
               <div className="absolute -bottom-8 left-1/2 -translate-x-1/2">
                 <div className="w-20 h-20 rounded-full bg-[#1c1b1d] border-4 border-[#0e0e10] flex items-center justify-center text-2xl font-black text-primary shadow-2xl">
                    {user?.email?.[0].toUpperCase() || 'U'}
                 </div>
               </div>
            </div>
            <div className="pt-10 pb-6 px-4 text-center">
              <h3 className="text-white font-bold text-lg tracking-tight truncate">{user?.email?.split('@')[0]}</h3>
              <p className="text-slate-500 text-[10px] font-label uppercase tracking-widest mt-1">Aspiring Polymath • Neural Explorer</p>
        ...
        <div className="lg:col-span-6 space-y-4">
          ...
          <div className="glass-panel rounded-xl p-4 border border-white/5 shadow-xl">
            <div className="flex gap-3 mb-4">
               <div className="w-12 h-12 rounded-full bg-slate-800 flex items-center justify-center text-primary font-black border border-white/5 shrink-0">
                 {user?.email?.[0].toUpperCase() || 'U'}
               </div>
               <button 
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-lg bg-slate-800 flex items-center justify-center text-slate-400 font-bold border border-white/5 shadow-inner">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-slate-500 leading-tight truncate">Verified Master of Quantum Mechanics</p>
                    ...
                    {post.goal_id && (
                      <div className="flex items-center gap-2 px-3 py-1.5 bg-primary/5 border border-primary/10 rounded-full w-fit mb-4 hover:bg-primary/10 transition-colors cursor-pointer group">
                        ...
                        <span className="text-[9px] font-black text-slate-400 group-hover:text-white uppercase tracking-widest transition-colors">Axiom Goal: Quantum Leap</span>
                      </div>
                    )}
                    ...
                    <div className="flex items-center justify-between pb-2 border-b border-white/5 mb-2">
                       <div className="flex items-center -space-x-1">
                          ...
                          <span className="text-[10px] text-slate-500 ml-4 font-medium">Ansh Chauhan and 11 others</span>
                       </div>
                       <span className="text-[10px] text-slate-500 font-medium">4 comments • 2 reposts</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-1">
                      <button className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg hover:bg-white/5 transition-colors group">
                        <Heart size={18} className="text-slate-500 group-hover:text-rose-500 transition-colors" />
                        <span className="text-xs font-bold text-slate-500 group-hover:text-slate-300">Like</span>
                      </button>
                      <button className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg hover:bg-white/5 transition-colors group">
                        <MessageSquare size={18} className="text-slate-500 group-hover:text-primary transition-colors" />
                        <span className="text-xs font-bold text-slate-500 group-hover:text-slate-300">Comment</span>
                      </button>
                      <button className="flex-1 flex items-center justify-center gap-2 py-3 rounded-lg hover:bg-white/5 transition-colors group">
